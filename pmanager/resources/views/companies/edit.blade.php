      ...
      <div class="row col-md-12 col-lg-12 col-sm-12" style="background-color: white; margin: 10px;">
     	<form method="post" action="{{route('companies.update',[$company->id])}}">
       	...
       	<div class="form-group">
       		...
       		<input type="text" name="c_name" placeholder="Enter Name" id="company-name" spellcheck="false" class="form-control" value="{{ $company->c_name}}" required="1">
       	</div>

       		<div class="form-group">
       		<label for="company-name">Description<span class="required">*</span>
       		</label>
       		<textarea type="text" style="resize: vertical;" name="c_description" placeholder="Enter Description" id="company-description" spellcheck="false" class="form-control autosize-target text-left" rows="5" required="1">{{ $company->c_description}}</textarea>
       	</div>
       <div class="form-group">
