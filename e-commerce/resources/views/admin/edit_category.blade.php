					...
					<div class="box-content">
						...
						<form class="form-horizontal" method="post" action="{{url('/update_category', $category_info->id)}}">
						  ...
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge " id="date01" name="category_name" value="{{$category_info->category_name}}">
							  </div>
							</div>
						...
						<!-- 	<div class="control-group">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="input-xlarge" name="category_desc" rows="3" >
