						...
						<tr>
							...
							<div class="cart_quantity_button">
								<form action="{{url('/update-cart')}}" method="post">
									{{ csrf_field()}}
									<input class="cart_quantity_input" type="text" readonly="1" name="qty" value="{{$v_contents->qty}}" autocomplete="off" size="2">
		...
		<div class="paymentCont col-sm-8">
					...
					<div class="paymentWrap">
						<div class="btn-group paymentBtnGroup btn-group-justified" data-toggle="buttons">
				            ...
				            <label class="btn paymentMethod">
			            		<div class="method payza"></div>
				                <input type="radio" name="payment_method" value="payza">
				            </label>
				       <label class="btn paymentMethod">
			             		<div class="method hand-cash"></div>
				                <input type="radio" name="payment_method" name="ezcash"> 
				            </label>
