			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/dashboard')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Social Link</span></a></li>
						<li><a href="{{URL::to('/dashboard')}}"><i class="icon-font"></i><span class="hidden-tablet"> Shop Name</span></a></li>
						<li><a href="{{URL::to('/dashboard')}}"><i class="icon-picture"></i><span class="hidden-tablet"> Delivary Man</span></a></li>
