...
<head>
  ...
  <!-- CSS Files -->
  <link href="{{asset('back-end/css/material-dashboard.css?v=2.1.1')}}" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="{{asset('back-end/demo/demo.css')}}" rel="stylesheet" />
...
<body>
 ...
 <!--   Core JS Files   -->
  ...
  <script src="{{asset('back-end/js/material-dashboard.js?v=2.1.1')}}" type="text/javascript"></script>
  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
  <script src="{{asset('back-end/demo/demo.js')}}"></script>
  <script>
