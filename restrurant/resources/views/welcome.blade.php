...
<html lang="en">
    <head>
        ...
        <!-- <link rel="shortcut icon" href="front-end/images/star.png" type="favicon/ico" /> -->
        ...
        <link rel="stylesheet" href="{{ asset('front-end/css/pricing.css')}}">
        <link rel="stylesheet" href="{{ asset('front-end/css/main.css')}}">
        <link rel="stylesheet" href="{{ asset('front-end/css/main.css')}}">
        <link rel="stylesheet" href="{{ asset('front-end/css/bootstrap-datetimepicker.min.css')}}">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">


        <script src="{{asset('front-end/js/jquery-1.11.2.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('front-end/js/jquefront-end/ry.flexslider.min.js')}}"></script>
...
{
    background: url('slider_image/slider/{{$slider->image}}');
    ...
    <body data-spy="scroll" data-target="#template-navbar">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img id="logo" src="{{asset('front-end/images/Logo_main.png')}}" class="logo img-responsive">
                    </a>
                </div>
            ...
            <div class="item">
                <div class="container">
                    <div class="header-content">
                        <h1 class="header-title" style="text-transform: uppercase;">{{$slider->title}}</h1>
        ...
        <section id="about" class="about">
            <img src="front-end/images/icons/about_color.png" class="img-responsive section-icon hidden-sm hidden-xs">
            <div class="wrapper">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                ...
                                <li class="item " id="{{$item->category->slug}}">
                                    ...
                                    <a href="#">
                                        <img src="item_image/item/{{$item->image}}" class="img-responsive" alt="Food" width="370px" height="500px">
...
{{--
        ...
        <section id="reserve" class="reserve">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="front-end/images/icons/reserve_black.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
        ...
        <section class="reservation">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="/front-end/images/icons/reserve_color.png">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class=" section-content">
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <form class="" method="post" action="{{ route('reservation.reserve') }}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="dateandtime" id="datetimepicker"  placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="#">Mamma's Kitchen.</a> Developed by <a href="http://github.com/Nazmul52"  target="_blank">Nazmul Huda</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript" src="{{asset('front-end/js/jquery.mixitup.min.js')}}" ></script>
        <script src="{{asset('front-end/js/wow.min.js')}}"></script>
        <script src="{{asset('front-end/js/jquery.validate.js')}}"></script>
        <script type="text/javascript" src="{{asset('front-end/js/jquery.hoverdir.js')}}"></script>
        <script type="text/javascript" src="{{asset('front-end/js/jQuery.scrollSpeed.js')}}"></script>
        <script src="{{asset('front-end/js/script.js')}}"></script>

        <script src="{{asset('front-end/js/bootstrap-datetimepicker.min.js')}}"></script>
